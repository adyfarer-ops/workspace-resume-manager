...
export const PROFILE_DATA: Profile = {
  ...
  avatar: "https://picsum.photos/400/400?grayscale", // Using a placeholder as I cannot extract the exact image file
  ...
  projects: [
    {
      ...
      role: "AI效能工程师",
      period: "2026年初 - 至今",
      tags: ["Kiro", "MCP", "Skills", "飞书", "钉钉", "DeepSeek", "Uni-app", "Vue3", "Supabase"],
      description: [],
      subProjects: [
        {
          id: "automation",
          ...
          tags: ["MCP", "Skills", "飞书", "钉钉"],
          techStack: ["Kiro", "Cursor", "Trae"]
        },
        {
          id: "zuihouyici",
          title: "最后亿次",
    ...
    },
    {
      ...
      role: "智能体开发者",
      period: "2025年初 - 至今",
      tags: ["Coze", "LLM", "Prompt Engineering"],
      description: [
