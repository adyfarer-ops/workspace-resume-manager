...
SET content = '<article class="prose prose-stone max-w-none">
  ...
  <!-- 架构图 -->
  <div class="my-8">
    <img src="/images/architecture.svg" alt="OpenClaw 微信接入架构图" class="w-full max-w-2xl mx-auto rounded-lg shadow-md border border-stone-200" />
    <p class="text-center text-sm text-stone-500 mt-2">▲ 整体架构：云服务器 → 企业微信 → 个人微信</p>
  </div>
  ...
  <!-- 流程图 -->
  <div class="my-8">
    <img src="/images/flowchart.svg" alt="配置流程图" class="w-full max-w-xl mx-auto rounded-lg shadow-md border border-stone-200" />
    <p class="text-center text-sm text-stone-500 mt-2">▲ 五步配置流程</p>
  </div>
