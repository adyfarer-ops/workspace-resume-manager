...
SET content = '<article class="prose prose-stone max-w-none">
  ...
  <div class="my-8">
    <img src="/images/article/step1-error.png" alt="OpenClaw 配置界面" class="w-full max-w-3xl mx-auto rounded-lg shadow-md border border-stone-200" />
    <p class="text-center text-sm text-stone-500 mt-2">▲ OpenClaw 管理界面，需要配置 Gateway Token 才能连接</p>
  </div>
  ...
  <div class="my-8">
    <img src="/images/article/step5-plugin-install.png" alt="安装企业微信插件" class="w-full max-w-2xl mx-auto rounded-lg shadow-md border border-stone-200" />
    <p class="text-center text-sm text-stone-500 mt-2">▲ 插件安装成功后的提示</p>
  </div>
  ...
  <div class="my-8">
    <img src="/images/article/step9-api-config.png" alt="设置 API 接收" class="w-full max-w-3xl mx-auto rounded-lg shadow-md border border-stone-200" />
    <p class="text-center text-sm text-stone-500 mt-2">▲ 企业微信后台，点击"设置API接收"进行配置</p>
  </div>
