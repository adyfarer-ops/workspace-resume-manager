-- 插入改写后的文章到 notes 表
INSERT INTO notes (title, content, summary, tags, source_url, is_imitation, status, created_at)
VALUES (
  '终于把 OpenClaw 塞进微信里了！踩坑实录 + 完整配置指南',
  '<article class="prose prose-stone max-w-none">
    ...
    <p class="leading-relaxed mb-4">登录<a href="https://work.weixin.qq.com/" class="text-blue-600 hover:underline">企业微信管理后台</a> → 应用管理 → 自建应用 → 创建应用。</p>
  ...
  "wecom-app": {
    ...
    <p class="leading-relaxed mb-4">对个人来说够用了。想要群聊的可以继续观望微信官方 Bot 接口，或者用企业微信的"客户群"功能。</p>
    
    <p class="leading-relaxed mb-4">有问题欢迎交流！</p>
    
    <hr class="my-8 border-stone-300" />
    
    <p class="text-sm text-stone-500 italic">原文链接：https://mp.weixin.qq.com/s/2IZLbrWVrxYF8Abjpv7yiw</p>
  </article>',
  '把 OpenClaw 接入微信的完整踩坑记录，基于企业微信官方接口，不走第三方协议，零封号风险。包含公网配置、插件安装、企业微信后台设置、微信端绑定等详细步骤，以及自动收藏公众号文章的实际应用案例。',
  ARRAY['OpenClaw', '微信', '企业微信', '教程', 'AI工具'],
  'https://mp.weixin.qq.com/s/2IZLbrWVrxYF8Abjpv7yiw',
  true,
  'published',
  NOW()
)
